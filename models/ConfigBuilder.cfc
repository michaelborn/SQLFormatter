component accessors="true" {
    ...
    property name="linesBetweenQueries" type="numeric" default="1";
    property name="maxColumnLength" type="numeric" default="50";
    property name="uppercase" type="boolean" default="false";
    property name="indent" type="string" default="  ";
    property name="params" type="any" default="{}";
     ...
     * 
     * @returns com.github.vertical_blank.sqlformatter.core.FormatConfig
     */
    ...
    public ConfigBuilder function setLinesBetweenQueries( required numeric linesBetweenQueries ){
        typeCheck( arguments.linesBetweenQueries, "linesBetweenQueries", "integer" );
    ...
    public ConfigBuilder function setMaxColumnLength( required numeric maxColumnLength ){
        typeCheck( arguments.maxColumnLength, "maxColumnLength", "integer" );
     ...
     */
    private void function typeCheck( required any value, required string name, required string expectedType ){
